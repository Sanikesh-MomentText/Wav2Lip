...
#                 bbox = int(bboxC.xmin * iw - 50), int(bboxC.ymin * ih - 80), \
#                        int(bboxC.width * iw + 80), int(bboxC.height * ih + 80)
#                 cv2.rectangle(image, bbox, (230, 0, 230), 2)
...
#                     face2 = bbox
#                     #x2, y2, w2, h2 = face2
#     lip_detect(image,face1,face2)

def lip_detect(image,bbox):
    thresh = 5
    face1=[]
    face2=[]
    ih, iw, ic = image.shape
    ...
    while True:
        ...
        index = [0, 11, 12, 13, 14, 15, 16, 17, 37, 72, 38, 82, 87, 86, 85, 84, 267, 302, 268, 312, 317, 316, 315, 314,
                 269,303, 271, 311, 402, 402, 404, 405, 270, 304, 272, 310, 318, 319, 320, 321, 409, 408, 407, 415, 324,
                 325,307, 375, 39, 73, 41, 81, 178, 179, 180, 181, 40, 74, 42, 80, 88, 89, 90, 91, 185, 184, 183, 191, 95,
                 96,77, 146]
        # x2, y2 = 0, 0
        flag=0
        c, p = 0, 0
            ...
            for i in range(0, 468):
                ...
                if i in index:
                    if i == 12:
                        ...
                        y1 = y
                    if i == 15:
                        k = int(math.sqrt(((x1 - x) ** 2) + ((y1 - y) ** 2)))
                    if k > thresh and x > (width // 2):
                        # for j in [0, 11]:
